...
#https://www.youtube.com/watch?v=ctmNq7FgbvI&list=PLblh5JKOoLUICTaGLRoHQDuF_7q2GfuJF&index=28&t=23s
...
mean((y.test - alpha1.predicted)^2)
    #[1] 1.184701  #this is better than the model that predicted 14.8
...
mean((y.test - alpha0.5.predicted)^2)
      #[1] 1.23797  this is larger than lasso, so this model is not ideal
...
results
      # alpha       mse fit.name
      # 1    0.0 14.745551   alpha0
      # 2    0.1  2.180112 alpha0.1
      # 3    0.2  1.524750 alpha0.2
      # 4    0.3  1.330456 alpha0.3
      # 5    0.4  1.303892 alpha0.4
      # 6    0.5  1.269930 alpha0.5
      # 7    0.6  1.220969 alpha0.6
      # 8    0.7  1.187826 alpha0.7
      # 9    0.8  1.195830 alpha0.8
      # 10   0.9  1.195623 alpha0.9
      # 11   1.0  1.184701   alpha1
#LAsso regression is best as fit @ 1 has the lowest values
